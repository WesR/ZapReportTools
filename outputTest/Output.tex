...
\item[] 18
\begin{tabular}{| l | p{12cm}}
uri & http://localhost/vulnerabilities/ \\
method & GET \\
param & X-Frame-Options \\
\end{tabular}
\item[] 19
\begin{tabular}{| l | p{12cm}}
uri & http://localhost/dvwa/includes/?C=M;O=A \\
method & GET \\
param & X-Frame-Options \\
\end{tabular}
\end{enumerate}
...
\item[] 17
\begin{tabular}{| l | p{12cm}}
uri & http://localhost/dvwa/images/?C=S;O=A \\
method & GET \\
evidence & Parent Directory \\
\end{tabular}
\item[] 18
...
\item[] 19
\begin{tabular}{| l | p{12cm}}
uri & http://localhost/dvwa/includes/?C=N;O=A \\
method & GET \\
evidence & Parent Directory \\
\end{tabular}
\end{enumerate}
